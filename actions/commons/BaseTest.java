...
public class BaseTest {
	...
	protected WebDriver getBrowserDriver(String serverName, String browserName, String appUrl, String ipAddress, String portNumber, String osName, String osVersion) {
		switch (serverName) {
		case "local":
