...
public class Level_20_Manage_Data_By_UserData extends BaseTest {
	...
	public void beforeClass(String browserName) {
		...
		this.firstName = UserData.Register.FIRST_NAME;
		this.lastName = UserData.Register.LAST_NAME;
		this.emailAdress = UserData.Register.EMAIL_ADDRESS + generateRandomNumber() + "@gmail.com";
		this.validPassword = UserData.Register.PASSWORD;
		this.date = UserData.Register.DATE;
		this.month = UserData.Register.MONTH;
		this.year = UserData.Register.YEAR;
		this.companyName = UserData.Register.COMPANY_NAME;
