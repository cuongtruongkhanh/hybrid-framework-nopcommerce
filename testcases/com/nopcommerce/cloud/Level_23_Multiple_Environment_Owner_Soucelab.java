...
public class Level_23_Multiple_Environment_Owner_Soucelab extends BaseTest {
	Environment environment;

	@Parameters({ "browser", "environment", "os" })
	@BeforeClass
	public void beforeClass(String browserName, String environmentName, String osName) {
		ConfigFactory.setProperty("env", environmentName);
		environment = ConfigFactory.create(Environment.class);

		driver = getBrowserDriverSouceLab(browserName, environment.appUrl(), osName);
